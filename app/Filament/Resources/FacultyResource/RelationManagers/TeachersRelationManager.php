...
class TeachersRelationManager extends RelationManager
{
    ...
    protected static ?string $title = 'Cán bộ - Giảng viên';

    public function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\Section::make('Thông tin cán bộ - giảng viên')
                    ->schema([
    ...
    public function table(Table $table): Table
    {
        return $table
            ...
            ->modifyQueryUsing(fn ($query) => $query->where('role', Role::Officer->value))
            ->columns([
                ...
                Tables\Actions\Action::make('import')
                    ...
                    ->action(function (array $data, RelationManager $livewire): void {
                        try {
                            ...
                            Excel::import(new TeachersImport($livewire->getOwnerRecord()->id), $file);
