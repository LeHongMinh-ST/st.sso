            ...
            <div class="page-header-content d-lg-flex border-top">
                <div class="d-flex">
                    <div class="py-2 breadcrumb">
                        ...
                        <a href="{{ route('user.index') }}" class="breadcrumb-item">Người dùng</a>
                        <a href="{{ route('user.show', $user->id) }}" class="breadcrumb-item">{{ $user->fullName }}</a>
                        <span class="breadcrumb-item active">Quản lý vai trò</span>
                    </div>
