                        ...
                        <div class="card-body">
                            ...
                            @if ($role == \App\IdentityAccess\Domain\Enums\Role::Student || $role == \App\IdentityAccess\Domain\Enums\Role::Officer)
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            <label class="form-label">{{ $role == \App\IdentityAccess\Domain\Enums\Role::Student ? 'Mã sinh viên' : 'Mã giảng viên' }} @if ($role == \App\IdentityAccess\Domain\Enums\Role::Student)
