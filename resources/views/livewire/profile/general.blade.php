            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" wire:model="email" placeholder="Nhập email" class="form-control" @if(auth()->user()->role !== \App\IdentityAccess\Domain\Enums\Role::Student->value) disabled @endif>
                        @error('email')
