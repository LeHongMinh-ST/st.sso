                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" wire:model="name" placeholder="Nhập tên vai trò" class="form-control @error('name') is-invalid @enderror" {{ $role->name === 'super-admin' ? 'disabled' : '' }}>
                                        @error('name')
                                                    ...
                                                    <div class="card-body">
                                                        @foreach($items as $permission)
                                                            <div class="form-check mb-2">
                                                                <input class="form-check-input" type="checkbox" wire:model="selectedPermissions" value="{{ $permission->code }}" id="permission_{{ $permission->id }}" {{ $role->name === 'super-admin' ? 'disabled checked' : '' }}>
        ...
        <div class="col-md-3 col-12">
            <div class="card">
                ...
                <div class="gap-2 card-body d-flex justify-content-center">
                    ...
                    @endif
                    <a href="{{ route('role.show', $role->id) }}" type="button" class="btn btn-warning flex-fill fw-semibold"><i
